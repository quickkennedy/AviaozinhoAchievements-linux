...
void M_LanConfig_Draw (void)
{
	...
	if (StartingGame)
	{
		...
		y += 16;  // Espaço extra para separar a mensagem
	...
	if (JoiningGame)
	{
		...
		y += 16;  // Espaço extra para separar a mensagem
M_Print(basex, y, "QUAKE NEEDS PORT FORWARD 26000");
y += 8;
M_Print(basex, y, "TO CREATE SERVERS");
y += 8;
M_Print(basex, y, "IF YOU CAN'T SORRY:(");
y += 8;
M_Print(basex, y, "USE HAMACHI OR RADMIN");
y += 8;
M_Print(basex, y, " ");
y += 4;
